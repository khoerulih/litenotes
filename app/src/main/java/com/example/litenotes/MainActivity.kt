...
import com.example.litenotes.adapter.NoteAdapter
import com.example.litenotes.databinding.ActivityMainBinding
import com.example.litenotes.db.NoteHelper
import com.example.litenotes.entity.Note
import com.example.litenotes.helper.MapHelper
        ...
        if (result.data != null) {
            when (result.resultCode) {
                NoteActivity.RESULT_ADD -> {
                    val note = result.data?.getParcelableExtra<Note>(NoteActivity.EXTRA_NOTE) as Note
